                ...
                <div className="content-container">
                    <div className="text-center mb-16">
                        <h1 className="text-4xl font-bold text-black mb-6">
                            ERC-20 <span className="text-orange-500">Allowance</span> Dashboard
                        </h1>
                        <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                            Manage your ERC-20 token allowances securely and efficiently on the <span className="text-orange-500 font-medium">Holesky</span> network
                        </p>
                    </div>
                    ...
                    <div className="mt-16">
                        <div className="card lg:mx-auto max-w-5xl">
                            ...
                            <p className="text-gray-600 mb-8">
                                This project was developed by <span className="text-orange-500">Eva MIRZA</span> as part of the <span className="text-orange-500">Junior Fullstack Case Study</span> internship. 
